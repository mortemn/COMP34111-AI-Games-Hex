...
class Node:
    def __init__(self, colour: Colour, move: Move, parent, board: Bitboard, root_colour: Colour, depth: int = 0):
    ...
    def search(self, limit):
        ...
        return Move(best_child.move[0], best_child.move[1]), iterations
...
class MCTSAgent(AgentBase):
    ...
    def make_move(self, turn: int, board: Board, opp_move: Move | None) -> Move:
        ...
        response, iterations = root.search(move_limit)
        end_time = time.time()
